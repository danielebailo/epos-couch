...
var config = [
					{
						...
						"color"		: "white",
						"position"	: "TL",
						"text"		: "R.I.D.E. Home page has a very simple structure: on the left column you have the Research Infrastructure (RI) list. On the right column you have a statistic tool, which enables you to carry on statistics on the RIs listed on the left. ",
						"time" 		: 5000
					}
