...
MyOtzivCl = function() {
    ...
    this.mo_showcss = function() {
       ...
       ref_ud(".frgtd{position:fixed; right:0px; top:0; z-index:5; width:39px; height:100%;}");
    ...
    this.mo_showframe = function() {
        ...
        if (!dref_mode) {
	        ...
	        if (!dref_ext_img)
		{
            ref_ud("<div class=\"frby\"><table height=\"100%\"><tr><td vertical-align=\"middle\"><a href=\""+vlink+"\""+((dref_waction)?' target=\"_blank\"':"")+"><img src=\""+siteAdr+"i/transp.gif\" alt=\"\" style=\"border: 0;\" width=\"22\" height=\"131\" class=\"tdsh\" /></a></td></tr></table></div>");
		}else
		{
		    ref_ud("<div class=\"frby\"><table height=\"100%\"><tr><td vertical-align=\"middle\"><a href=\""+vlink+"\""+((dref_waction)?' target=\"_blank\"':"")+"><img src=\""+(dref_ext_img_m ?reformal_wdg_bimage : siteAdr+'files/images/buttons/'+reformal_wdg_bimage)+"\" alt=\"\" style=\"border: 0;\" class=\"tdsh\" /></a></td></tr></table></div>");
		}
            } 
            else {
		if (!dref_ext_img)
		{
            ref_ud("<div class=\"frgtd\"><table height=\"100%\"><tr><td vertical-align=\"middle\"><a href=\""+vlink+"\""+((dref_waction)?' target=\"_blank\"':"")+"><img src=\""+siteAdr+"i/transp.gif\" alt=\"\" style=\"border: 0;\" width=\"39\" height=\"131\" class=\"tdsh\" /></a></td></tr></table></div>");}else
		{
		    ref_ud("<div class=\"frgtd\"><table height=\"100%\"><tr><td vertical-align=\"middle\"><a href=\""+vlink+"\""+((dref_waction)?' target=\"_blank\"':"")+"><img src=\""+(dref_ext_img_m ?reformal_wdg_bimage : siteAdr+'files/images/buttons/'+reformal_wdg_bimage)+"\" alt=\"\" style=\"border: 0;vertical-align: middle;\" class=\"tdsh\" /></a></td></tr></table></div>");
